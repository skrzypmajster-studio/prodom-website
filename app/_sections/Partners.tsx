    ...
    <section id="partnerzy" className="py-20 bg-gray-100">
        <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-4 gap-6">
                <div className="border border-gray-300 rounded-xl p-6 text-center font-semibold text-[#555555] flex items-center justify-center">
                ...
                <div className="border border-gray-300 rounded-xl p-6 text-center font-semibold text-[#555555] flex items-center justify-center bg-black">
