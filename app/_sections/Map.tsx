    ...
    <section id="mapa" className="py-20 bg-gray-100">
        <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="rounded-2xl overflow-hidden shadow-lg h-[450px]">
                <iframe className="w-full h-full" title="Mapa dojazdu PRODOM" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyB2NIWI3Tv9iDPrlnowr_0ZqZWoAQydKJU&q=ulica%20%C5%81%C4%99cka%2061%2C%20Jawiszowice%2C%20Polska&maptype=roadmap" style={{ border: 0 }} allowFullScreen={false} loading="lazy"></iframe>
