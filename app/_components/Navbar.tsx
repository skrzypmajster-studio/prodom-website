        ...
        <header className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-gray-200">
            <div className="max-w-6xl mx-auto px-6 flex items-center justify-between py-4">
                ...
                <nav id="menu" className={`absolute top-full left-0 w-full bg-white md:bg-transparent border-t border-gray-200 md:static md:w-auto md:flex md:items-center md:gap-4 md:border-0 md:bg-transparent${!isActive ? ' hidden' : ''}`}>
                    <ul className="flex flex-col md:flex-row md:gap-4 p-4 md:p-0 text-[#555555]">
                        ...
                        <li><a className="bg-[#F95300] hover:bg-[#d64500] text-white px-4 py-2 rounded-xl font-semibold block mt-2 md:mt-0" href="/#kontakt" onClick={handleMenuItemClick}>Wyceń inwestycję</a></li>
                    </ul>
                </nav>
            </div>
        </header>
