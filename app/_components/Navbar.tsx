    ...
    return (
        <header className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-gray-200">
            <div className="max-w-6xl mx-auto px-6 flex items-center justify-between py-4">
                ...
                <nav id="menu" className={`absolute top-full left-0 w-full bg-white border-t border-gray-200 md:static md:w-auto md:flex md:items-center md:gap-4 md:border-0 md:bg-transparent${!isActive ? ' hidden' : ''}`}>
